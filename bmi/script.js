...
//change BMI tag according to the BMI value (WHO classification)
function changeBmiTagAndValue() {
  outputBmiValue.textContent = bmi;

  if (bmi < 16) {
    bmiTag.textContent = "Severe Thinness";
    bmiTag.style.color = "#f57c00"; 
  } else if (bmi >= 16 && bmi < 17) {
    bmiTag.textContent = "Moderate Thinness";
    bmiTag.style.color = "#ff9800"; 
  } else if (bmi >= 17 && bmi < 18.5) {
    bmiTag.textContent = "Mild Thinness";
    bmiTag.style.color = "#ffc107"; 
  } else if (bmi >= 18.5 && bmi < 25) {
    bmiTag.textContent = "Normal";
    bmiTag.style.color = "#009688"; 
  } else if (bmi >= 25 && bmi < 30) {
    bmiTag.textContent = "Overweight";
    bmiTag.style.color = "#f44336"; 
  } else if (bmi >= 30 && bmi < 35) {
    bmiTag.textContent = "Obese Class I";
    bmiTag.style.color = "#d32f2f"; 
  } else if (bmi >= 35 && bmi < 40) {
    bmiTag.textContent = "Obese Class II";
    bmiTag.style.color = "#b71c1c"; 
  } else if (bmi >= 40) {
    bmiTag.textContent = "Obese Class III";
    bmiTag.style.color = "#880e4f"; 
  }
